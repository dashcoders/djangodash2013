...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_user', (
            ...
            ('facebook_id', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True, null=True)),
            ('facebook_access_token', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
    ...
    models = {
        u'accounts.user': {
            ...
            'facebook_id': ('django.db.models.fields.CharField', [], {'max_length': '20', 'unique': 'True', 'null': 'True'}),
